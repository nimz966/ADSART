            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-12 p-5">
                        <h3 class="lable p-4 text-center">My Events</h3>
                        <div class="wrap-table100 w-100">
                            ...
                            <table class="table100 ver1 m-110 table-striped" id="example">
                                <!-- Table head -->
                    ...
                    <div class="col-12 p-5">
                        <h3 class="lable p-4 text-center">Notices</h3>
                        <div class="wrap-table100 justify-content-center">

                            <!-- Notices detail table -->
                            <table class="table100 ver1 m-110 table-striped" id="examp">
                                <!-- Table head -->
                                <div class="table100-head ">

                                    <thead>
                                        <tr class="row100 head">
                                            <th class="cell100 column1 text-center p-3">Notice</th>
