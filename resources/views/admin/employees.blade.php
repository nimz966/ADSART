                            ...
                            <tr class="row100 body">
                                ...
                                <td class="cell100 column6">
                                    <ul class="list-inline m-0">
                                        ...
                                        <li class="list-inline-item" data-toggle="modal" data-placement="bottom" title="Edit" data-target="#exampleModal"><a id="edit"><i class="fa fa-edit"></i></a>
                                        </li>
                                        <!-- Employee edit modal -->
                                        ...
                                        <li class="list-inline-item" data-toggle="modal" data-placement="bottom" title="Delete" data-target="#exampleModal1"><a id="delete"><i class="fa fa-trash"></i></a>
                                        </li>
